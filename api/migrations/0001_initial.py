# Generated by Django 2.0.3 on 2018-11-28 02:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.CharField(blank=True, max_length=255, verbose_name='enrollment')),
                ...
                ('hand', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Left'), (2, 'Right')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared_with_devices', models.ManyToManyField(blank=True, related_name='allowed_shared_exercises', to='api.Device')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=storages.backends.gcloud.GoogleCloudStorage(bucket_name=None), upload_to='videos')),
